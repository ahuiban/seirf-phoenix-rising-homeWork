...
>**Note:** This is about the time you should stop on Day 1 for this HW. If you have not yet spent 4 hours, we recommend cleaning up CSS, and then making a quick attempt at one of the commits below. We will cover this material in more detail in future classes, and you will have a chance to finish it for the next HW period.
...
You will be required to submit this particular assignment before next class, and to submit a final version by next week (at beginning of class time). We suggest that you try not to save it all for Thursday night and at least try to do the following:
